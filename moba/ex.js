...
function $UG$SIPD$Effect$teleport$(_$0/*:BigInt*/,_$1/*:BigInt*/,_$2/*:Number*/,_$3/*:UG/SIPD/State*/) {var $x1 = _$3;var $x2 = $x1.game_map;var $x3 = ({$: "Pair"});var $x5 = $x1.players;var $x6 = _$0;var $x4 = $UG$SIPD$Player$get_player$($x5, $x6);$x3.fst = $x4;var $x8 = $x2.bodies;var $x9 = _$1;var $x7 = $UG$SIPD$GameMap$get_body$($x8, $x9);$x3.snd = $x7;var $x10 = $x3.fst;switch ($x10.$) { case "None": { var $x11 = $x3.snd;switch ($x11.$) { case "None": { var $x0 = ({$: "State"});var $x12 = $x1.next_id;$x0.next_id = $x12;var $x13 = $x1.tick;$x0.tick = $x13;var $x14 = $x1.players;$x0.players = $x14;var $x15 = $x1.hero_states;$x0.hero_states = $x15;var $x16 = ({$: "GameMap"});var $x17 = $x2.width;$x16.width = $x17;var $x18 = $x2.height;$x16.height = $x18;var $x19 = $x2.bodies;$x16.bodies = $x19;$x0.game_map = $x16; break; } default: { var $x0 = ({$: "State"});var $x20 = $x1.next_id;$x0.next_id = $x20;var $x21 = $x1.tick;$x0.tick = $x21;var $x22 = $x1.players;$x0.players = $x22;var $x23 = $x1.hero_states;$x0.hero_states = $x23;var $x24 = ({$: "GameMap"});var $x25 = $x2.width;$x24.width = $x25;var $x26 = $x2.height;$x24.height = $x26;var $x27 = $x2.bodies;$x24.bodies = $x27;$x0.game_map = $x24; break; } } break; } case "Some": { var $x28 = $x10.value;switch ($x28.$) { case "Player": { var $x29 = $x3.snd;switch ($x29.$) { case "None": { var $x0 = ({$: "State"});var $x30 = $x1.next_id;$x0.next_id = $x30;var $x31 = $x1.tick;$x0.tick = $x31;var $x32 = $x1.players;$x0.players = $x32;var $x33 = $x1.hero_states;$x0.hero_states = $x33;var $x34 = ({$: "GameMap"});var $x35 = $x2.width;$x34.width = $x35;var $x36 = $x2.height;$x34.height = $x36;var $x37 = $x2.bodies;$x34.bodies = $x37;$x0.game_map = $x34; break; } case "Some": { var $x38 = $x29.value;var $x39 = $x38.hitbox;var $hitbox_center$0 = $UG$Shape$get_center$($x39);var $x41 = $x28.target;var $x42 = $hitbox_center$0;var $x40 = $V2$sub$($x41, $x42);var $direction$1 = $V2$normalize$($x40);var $x44 = $x28.target;var $x45 = $hitbox_center$0;var $x43 = $V2$sub$($x44, $x45);var $distance$2 = $V2$length$($x43);var $x46 = $distance$2;var $x47 = _$2;var $teleport_dist$3 = $F64$min$($x46, $x47);var $x48 = $direction$1;var $x49 = $teleport_dist$3;var $movement$4 = $V2$mul_scalar$($x48, $x49);var $x50 = $hitbox_center$0;var $x51 = $movement$4;var $new_center$5 = $V2$add$($x50, $x51);var $x52 = $x38.hitbox;var $x53 = $movement$4;var $new_hitbox$6 = $UG$Shape$move$($x52, $x53);var $x54 = JSTR_TO_LIST(`HERE ON TELEPORT`);var $x56 = ({$: "State"});var $x57 = $x1.next_id;$x56.next_id = $x57;var $x58 = $x1.tick;$x56.tick = $x58;var $x59 = $x1.players;$x56.players = $x59;var $x60 = $x1.hero_states;$x56.hero_states = $x60;var $x61 = ({$: "GameMap"});var $x62 = $x2.width;$x61.width = $x62;var $x63 = $x2.height;$x61.height = $x63;var $x64 = $x2.bodies;$x61.bodies = $x64;$x56.game_map = $x61;var $x65 = ({$: "Body"});var $x66 = $x38.id;$x65.id = $x66;var $x67 = $new_hitbox$6;$x65.hitbox = $x67;var $x68 = $x38.tick;$x65.tick = $x68;var $x69 = $x38.effects;$x65.effects = $x69;var $x70 = $x38.collidable;$x65.collidable = $x70;var $x55 = $UG$SIPD$State$insert_body$($x56, $x65);var $x0 = (console.log(LIST_TO_JSTR($x54)), $x55); break; } } break; } default: { var $x72 = /*Type*/null;var $x73 = $x28;var $x71 = ($x72)($x73);var $x74 = $x3.snd;var $x0 = ($x71)($x74); break; } } break; } default: { var $x76 = /*Type*/null;var $x77 = $x10;var $x75 = ($x76)($x77);var $x78 = $x3.snd;var $x0 = ($x75)($x78); break; } }return $x0; }
...
function $make_skills$(_$0/*:UG/SIPD/State*/,_$1/*:BigInt*/,_$2/*:BigInt*/) {var $x1 = _$0;var $x2 = $String;var $x3 = $UG$SIPD$Skill;var $s$0 = $OrdTree$empty$($x2, $x3);var $x4 = $s$0;var $x5 = JSTR_TO_LIST(`RightClick`);var $x7 = _$1;var $x8 = _$2;var $x9 = 0n;var $x6 = $UG$SIPD$Skill$move$($x7, $x8, $x9);var $s$1 = $insert_skill$($x4, $x5, $x6);var $x10 = $s$1;var $x11 = JSTR_TO_LIST(`E`);var $x13 = _$1;var $x14 = _$2;var $x15 = 100.0;var $x16 = 100n;var $x12 = $UG$SIPD$Skill$teleport$($x13, $x14, $x15, $x16);var $s$2 = $insert_skill$($x10, $x11, $x12);var $x17 = $String;var $x18 = /*BigInt*/null;var $s_cooldowns$3 = $OrdTree$empty$($x17, $x18);var $x19 = $s_cooldowns$3;var $x20 = JSTR_TO_LIST(`RightClick`);var $x21 = 0n;var $s_cooldowns$4 = $insert_cooldown$($x19, $x20, $x21);var $x22 = $s_cooldowns$4;var $x23 = JSTR_TO_LIST(`E`);var $x24 = 0n;var $s_cooldowns$5 = $insert_cooldown$($x22, $x23, $x24);var $x25 = /*BigInt*/null;var $x26 = $UG$SIPD$Hero$HeroState;var $x27 = $U64$Ord;var $x28 = $x1.hero_states;var $x29 = ({$: "Pair"});var $x30 = _$1;$x29.fst = $x30;var $x31 = ({$: "HeroState"});var $x32 = $s_cooldowns$5;$x31.cooldowns = $x32;$x29.snd = $x31;var $new_hero_states$6 = $OrdTree$insert$($x25, $x26, $x27, $x28, $x29);var $x0 = ({$: "Pair"});var $x33 = $s$2;$x0.fst = $x33;var $x34 = ({$: "State"});var $x35 = $x1.next_id;$x34.next_id = $x35;var $x36 = $x1.tick;$x34.tick = $x36;var $x37 = $x1.players;$x34.players = $x37;var $x38 = $new_hero_states$6;$x34.hero_states = $x38;var $x39 = $x1.game_map;$x34.game_map = $x39;$x0.snd = $x34;return $x0; }
...
function $UG$SIPD$Hero$apply_skill_if_pressedd$(_$0/*:String*/,_$1/*:BigInt*/,_$2/*:OrdTree<String><UG/SIPD/Skill>*/,_$3/*:OrdTree<String><Pair<Bool><V2>>*/,_$4/*:OrdTree<String><BigInt>*/,_$5/*:UG/SIPD/State*/) {var $x2 = $String;var $x3 = $UG$SIPD$Skill;var $x4 = $String$Ord;var $x5 = _$2;var $x1 = $OrdTree$get$($x2, $x3, $x4, $x5);var $x6 = _$0;var $player_skill$0 = ($x1)($x6);var $x8 = $String;var $x9 = $UG$SIPD$Skill;var $x10 = _$2;var $x7 = $OrdTree$keys$($x8, $x9, $x10);var $x12 = $player_skill$0;switch ($x12.$) { case "None": { var $x11 = _$5; break; } case "Some": { var $x13 = _$0;var $x14 = _$3;var $is_key_pressed$1 = $UG$SIPD$Player$is_player_key_pressed$($x13, $x14);var $x11 = _$5; break; } }var $x0 = (console.log(LIST_TO_JSTR($x7)), $x11);return $x0; }
const $UG$SIPD$Hero$apply_skill_if_pressedd = _$0 => _$1 => _$2 => _$3 => _$4 => _$5 => $UG$SIPD$Hero$apply_skill_if_pressedd$(_$0,_$1,_$2,_$3,_$4,_$5)
...
export { $BinTree, $Maybe, $BinMap, $BinMap$empty, $Bits, $BinMap$get, $BinMap$new, $BinMap$set, $Bool, $Bool$and, $Bool$eq, $Bool$if, $Bool$not, $Char, $U64$to_bool, $U64$eql, $Cmp, $U64$compare, $Char$compare, $Ord, $Char$Ord, $Char$eq, $Equal, $F64$add, $F64$div, $F64$eql, $F64$eq, $F64$is_zero, $F64$lt, $F64$min, $F64$mul, $F64$sqrt_go, $F64$sqrt, $F64$sub, $KEYEVENT, $KEYMOUSE, $List, $List$append, $List$foldr, $List$fold, $List$foldl, $MOUSECLICK, $MOUSEMOVE, $Maybe$none, $Nat, $Nat$add, $Nat$lte, $Nat$gte, $Nat$max, $Ord$compare, $Pair, $OrdTree$Balance, $OrdTree, $OrdTree$Balance$rotate_left, $OrdTree$Balance$rotate_right, $OrdTree$empty, $OrdTree$fold, $OrdTree$get, $OrdTree$height, $Pair$get_fst, $OrdTree$insert$go, $OrdTree$insert, $OrdTree$keys, $OrdTree$singleton, $OrdTree$size, $OrdTree$values, $SETNICK, $String, $String$compare, $String$Ord, $String$eq, $U64$Ord, $U64$add, $U64$div, $U64$eq, $U64$from_bool, $U64$gt, $U64$lt, $U64$max, $U64$min, $U64$mod, $U64$mul, $U64$neq, $U64$sub, $U64$to_bits, $UG$Collision$Collidable, $UG$SIPD$Action, $UG$SIPD$Action$eq, $V2, $UG$Shape, $UG$SIPD$Effect, $UG$SIPD$Skill, $UG$SIPD$Hero, $UG$SIPD$Player, $UG$SIPD$Hero$HeroState, $UG$SIPD$GameMap, $UG$SIPD$State, $UG$SIPD$Body, $UG$SIPD$Body$set_effects, $UG$SIPD$Body$apply_effects$go, $UG$SIPD$Body$apply_effects, $UG$SIPD$Body$tick, $UG$Shape$get_center, $V2$sub, $V2$length, $V2$div_scalar, $V2$is_zero, $V2$normalize, $V2$mul_scalar, $V2$add, $UG$Shape$move, $UG$SIPD$Player$get_player, $UG$SIPD$GameMap$get_body, $UG$SIPD$Effect$move, $UG$SIPD$GameMap$insert_body, $UG$SIPD$State$insert_body, $UG$SIPD$Effect$teleport, $UG$SIPD$Event$Click, $UG$SIPD$Event, $UG$SIPD$Event$Click$eq, $UG$SIPD$Event$eq, $UG$SIPD$Event$get_event_pid, $UG$SM$Game, $UG$SIPD$Game, $UG$SIPD$GameMap$init, $UG$SIPD$Game$init, $update_cooldown, $decrement_cooldowns, $update_hero_state, $update_cooldowns, $UG$SIPD$Game$tick, $get_player_name, $UG$SIPD$State$generate_id, $UG$Shape$circle, $get_body_effects_state, $UG$SIPD$Hero$HeroState$key_on_cooldown, $UG$SIPD$Skill$apply, $get_skill, $UG$SIPD$Player$is_player_key_pressed, $UG$SIPD$Hero$apply_skill_if_pressed, $UG$SIPD$Hero$apply_pressed_skills, $tick, $insert_skill, $UG$SIPD$Skill$move, $UG$SIPD$Skill$teleport, $insert_cooldown, $make_skills, $UG$SIPD$Hero$li_ming, $p_hero, $initial_keys, $UG$SIPD$Player$init, $players_get, $handle_new_player, $update_player_name, $get_mouse_pos, $get_key_value, $update_player_key, $update_player_target, $handle_event, $UG$SIPD$Game$when, $UG$SIPD$Hero$apply_skill_if_pressedd, $UG$SM$ActionLogs, $UG$SM$Tick, $UG$SM$ActionLogs$add_action, $UG$SM$ActionLogs$get_actions, $UG$SM$Game$init, $UG$SM$Game$tick, $UG$SM$Game$when, $UG$SM$StateLogs$StateNode, $UG$SM$StateLogs, $UG$SM$Mach, $UG$SM$Mach$action_logs, $UG$SM$Mach$cached_tick, $UG$SM$StateLogs$StateNode$keep, $UG$SM$StateLogs$StateNode$life, $UG$SM$StateLogs$StateNode$older, $UG$SM$StateLogs$StateNode$set_keep, $UG$SM$StateLogs$StateNode$set_life, $UG$SM$StateLogs$StateNode$state, $UG$SM$StateLogs$StateNode$tick, $UG$SM$StateLogs$find_rollback_amount$go, $UG$SM$StateLogs$find_rollback_amount, $UG$SM$StateLogs$push$go$life, $UG$SM$StateLogs$push$go, $UG$SM$StateLogs$push, $UG$SM$StateLogs$rollback$go, $UG$SM$StateLogs$rollback, $UG$SM$Time, $UG$SM$Time$time_to_tick, $UG$SM$TimedAction, $UG$SM$TimedAction$time_action, $UG$SM$add_action_to_logs, $UG$SM$get_initial_state, $UG$SM$update_mach, $UG$SM$compute$go, $UG$SM$compute, $UG$SM$new_mach, $UG$SM$update_genesis_tick, $UG$SM$update_cached_tick, $UG$SM$remove_future_states, $UG$SM$register_action, $apply_skill_if_not_on_cooldown, $default_hero, $export_action_eq, $export_compute, $export_game, $export_game_init, $export_game_tick, $export_game_when, $export_register_action, $export_time_action, $test$0, $test$1, $test$10, $test$2, $test$3, $test$4, $test$5, $test$6, $test$7, $test$8, $test$9 }
